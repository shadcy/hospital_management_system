...
?>
    ...
    <head>
        <title> <?php echo $userTypeString; ?> | Login History</title>
                ...
                <div class="layout-page">
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Doctor/</span>Attendance</h4>

                            <div class="col-xl">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        <button class="btn btn-primary" id="find-me">Mark Attendance</button><br />
                                        <p id="status"></p>
