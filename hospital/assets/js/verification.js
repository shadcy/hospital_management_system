    ...
    reader.onload = function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                let decryptedDataURL = "data:image/png;base64," + response.imageData;
                let dataString = `Doctor Name: <b>${response.doctor}</b><br>Generated at: ${formatTimestamp(response.timestamp)}`
